...
export default function BusinessPage({ state, mutate, busy }:SectionProps) {
  ...
  {!portfolio || businesses.length===0 ? <Callout title="Aucune participation déclarée">Ajoute une société puis renseigne sa détention. Une dette corporate à 0 doit être saisie comme 0 si elle est réellement nulle ; une dette inconnue reste vide.</Callout> : <>
  ...
  <BusinessForms businesses={businesses} mutate={mutate} busy={busy}/></div>;
}
