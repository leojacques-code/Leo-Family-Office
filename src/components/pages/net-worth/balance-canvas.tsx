...
function blockHeight(block: NetWorthBlock): number | null {
  ...
  return block.weight * TRACK_HEIGHT;
}
...
function BalanceBlock({
  ...
  return (
    ...
    >
      {height === null ? null : (
        <span aria-hidden="true" className="nw-block-measure" style={{ height }} />
      )}
      <span className="nw-block-content">
        ...
        <button className="nw-result" onClick={onSelectNetWorth} type="button">
          ...
          {view.closeChange.view ? (
            ...
            >
              ...
              <Currency value={Math.abs(view.closeChange.view.amount)} compact /> entre le{" "}
              {view.closeChange.view.fromDate} et le {view.closeChange.view.toDate}
            </span>
          ) : (
