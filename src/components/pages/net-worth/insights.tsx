    ...
    <section aria-label="Évolution depuis la clôture" className="nw-panel">
      ...
      {view.closeReadiness.ready ? (
        <button
          ...
          type="button"
        >
          {closeDate ? `Arrêter le patrimoine au ${closeDate}` : "Date opérationnelle indisponible"}
        </button>
      ) : (
        <p className="nw-note">
...
export function NetWorthInsights({
  ...
  return (
    <div className="nw-secondary">
      ...
      <CloseChangePanel closeDate={closeDate} busy={busy} onClose={onCreateClose} view={view} />
