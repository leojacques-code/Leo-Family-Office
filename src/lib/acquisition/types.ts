...
export const IMPORT_ISSUE_CODES = [
  ...
  "POSSIBLE_MATCH",
  // Open Banking — consentement et fournisseur
  "BANK_CONSENT_EXPIRED",
  "BANK_CONSENT_REVOKED",
  "BANK_CONSENT_SCOPE_MISSING",
  "BANK_SECRET_REFERENCE_MISSING",
  "BANK_PROVIDER_UNAUTHORIZED",
  "BANK_PROVIDER_FORBIDDEN",
  "BANK_PROVIDER_RATE_LIMITED",
  "BANK_PROVIDER_SERVER_ERROR",
  "BANK_PROVIDER_TIMEOUT",
  "BANK_PROVIDER_NETWORK_ERROR",
  "BANK_PROVIDER_MALFORMED_RESPONSE",
  "BANK_PROVIDER_NOT_SERVED",
  // Open Banking — pagination et rejeu
  "BANK_PAGE_REPLAYED",
  "BANK_PAGE_LIMIT_REACHED",
  "BANK_CURSOR_NOT_ADVANCING",
  "BANK_SYNC_RESUMED",
  "BANK_WEBHOOK_REPLAYED",
  // Open Banking — observation
  ...
  // Open Banking — réconciliation
  "BANK_RECONCILIATION_DECIDED",
  "BANK_RECONCILIATION_AMBIGUOUS",
] as const;
