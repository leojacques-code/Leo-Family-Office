...
Le formatage pur partagé rend aussi les cinq messages monétaires de debt.ts dans la devise native. Seules leurs chaînes explicatives changent : aucune formule, branche de calcul ou résultat numérique modifié. L’axe adapte sa largeur aux libellés monétaires. L’aperçu CSV affiche la devise du contrat dans sa synthèse et ses lignes, sans convertir ni enregistrer automatiquement. Les montants du formulaire avancé sont couverts par l’annonce commune de devise ; l’encours observé l’annonce dans sa fenêtre.
